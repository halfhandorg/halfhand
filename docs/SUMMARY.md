...
- [Redaction design](./redaction-design.md)
...
- [Shell completions & man page](./completions.md)
...
- [Architecture decision records](./adr/0001-threads-vs-tokio.md)
  ...
  - [ADR 0002: stored step ordinals](./adr/0002-stored-step-ordinals.md)
  - [ADR 0003: FTS index strategy](./adr/0003-fts-index-strategy.md)